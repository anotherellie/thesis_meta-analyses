capture log close
cd "N:\Eking\Prevalence_study_data\Do_files\THESIS METAANALYSES"

set more off
clear
use "C:\EllieDropboxCache\Dropbox\PhD\My research\THESIS\CHAPTERS\CH2_LIT_REVIEW\sero.dta"
...
(scatter p_h16 medianage [aw=1/se_h16^2], msymbol (none) mlabel(Study) mlabsize(small) mlabposition(3) mlabgap(3) mlabcolor(black)), 
...
;
 graph save Graph "N:\Eking\Prevalence_study_data\Do_files\THESIS METAANALYSES\medianage_seroprev.gph"
 ;
 
#delimit ;
 graph combine hpv16.gph medianage_seroprev.gph, note("" , size (vsmall))
ysize(4.6)
xsize(8.6)
