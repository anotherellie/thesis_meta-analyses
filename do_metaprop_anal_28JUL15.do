...
lcols(Study sample studylocation recruit )
texts(140)
xscale(r(0, 0.7))
...
xsize(10.67)
;  
graph export "N:\Eking\Prevalence_study_data\Graphs\meta_anal_HR.tif", replace width(1500)
...
;
#delimit ;
mymetaprop hpv11 sample if year<2009, by(hiv) random cimethod(exact) nowt
lcols(Study sample studylocation recruit )
texts(120)
xlabel(10,20, 30, 40, 50, 60, 70)
xtitle("Prevalence (%)", size(vsmall)) 
